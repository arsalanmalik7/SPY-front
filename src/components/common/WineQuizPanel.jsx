                          ...
                          return (
                            ...
                            >
                              <input
                                ...
                                disabled={answered}
                              />
                              {opt.startsWith('http') || opt.startsWith('/uploads/') ? (
                                <img className="mx-auto my-2 block max-h-52" src={opt.startsWith('http') ? opt : process.env.REACT_APP_IMAGE_BASE_URL + opt} alt="option" />
                              ) : (
                                <span className="text-base sm:text-lg text-black font-medium leading-tight break-words ">{opt}</span>
                              )}
                            </label>
                          );
                        })}
