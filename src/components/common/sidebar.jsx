...
const navItems = [
  ...
  { icon: 'history', label: 'Previous Menu', href: '/previous-menu' },
...
export default function Sidebar({ isOpen, setIsOpen }) {
  ...
  const filteredNavItems = navItems.filter(item => {
    if (userRole === 'super_admin') {
      ...
      return ['/dashboard', '/staff-management', '/my-lessons', '/subscription', '/progress', "/menu-management", "/previous-menu", "/lesson-progress", "/restaurant-management"].includes(item.href);
    } else if (userRole === 'director') {
      return ['/dashboard', '/staff-management', '/restaurant-management', '/menu-management', "/previous-menu", "/lesson-progress", '/my-lessons', '/subscription', '/progress'].includes(item.href);
    } else if (userRole === 'employee') {
      return ['/my-lessons', '/menu-management', '/progress'].includes(item.href);
    }
    return true;
  });
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 left-0 z-50 w-64 h-screen bg-white border-r border-gray-200 overflow-y-auto transform transition-transform duration-300 
        ${isOpen ? 'translate-x-0' : '-translate-x-full'} 
        lg:translate-x-0 lg:sticky lg:top-0 lg:z-0 lg:h-screen`}
      >
              ...
              return (
                <li key={item.label}>
                  ...
                  >
                    ...
                    <span>{item.label === 'Menu Management' && userRole === 'employee' ? 'Menu': item?.label}</span>
                  </Link>
                </li>
              );
            })}
